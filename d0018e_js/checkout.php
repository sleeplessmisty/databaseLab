...
$sql = "SELECT * FROM billing WHERE cartid = '$cart_id'";
$result = $db->query($sql);
            ...
            <div class="cart">
                <div class="product">
                    <div class="product-info">
                        ...
                        <h6 class="product-price">Price: <?php echo $product_price ?> SEK</h6>
                        <h6 class="product-quantity">Quantity: <?php echo $product_quantity ?></h6>
                        <br>                                  
                </div>
        </div>
    </section>
...
<h3>Cart Total: <?php echo $totalSumCart ?> SEK</h3>
                            ...
                            <div class="right_list"> 
                                ...
                                <br>
                                <br>
                                <br><form method="post" action="checkout.php">
                                <button type="submit" class="button" name="placeOrder_btn" value="<?php echo $placeOrder_btn; ?>">Place order</button></form></div>
        <br>
        <!-- Footer-->
