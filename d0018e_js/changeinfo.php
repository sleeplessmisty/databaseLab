    ...
    <body>
        ...
        <form method="post" action="accountinfo.php">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="password_1" placeholder="Enter password" name="password_old" value="<?php echo $password_old; ?>">
                <div class="form-group">
                    <label for="password_1">New password:</label>
                    <input type="password" class="form-control" id="password_1" placeholder="Enter password" name="password_1" value="<?php echo $password_1; ?>">
                </div>
                <div class="form-group">
                    <label for="password_2">Confirm new password:</label>
                    <input type="password" class="form-control" id="password_2" placeholder="Confirm password" name="password_2" value="<?php echo $password_2; ?>">
                </div>
                <div class="checkbox">
                    </div>
                    <br>
