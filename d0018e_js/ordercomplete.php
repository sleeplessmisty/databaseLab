<?php 
    ...
    $last_cart_id = $_SESSION['last_cart_id'];
    $customer_id = $_SESSION['customerId'];
    $order_id = $_SESSION['order_id'];
    $totalSumCart = totalSumCart($last_cart_id);
    global $db;
?>
  ...
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/4.19.1/js/mdb.min.js" integrity="sha512-KTZG+1kavc6Zo0P/8ftnVEODVgBfC5BnV9j5OMcYiDDKyvdt/TlomZkjrQg8uM7VymvKxSx7t9Xp8iAgDh/NvQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p class="lead fw-normal text-black-50 mb-0">Thank you for your order! A confirmation email with full details has been sent to your registered address. We hope to see you again soon!</p>
            <br>
            Your order number: <?php echo $order_id ?> <br>
            Order total: <?php echo $totalSumCart ?> SEK
            <br>
            <br>
            <p class="lead fw-normal text-black-50 mb-0">Leave a review of products you haven't purchased before below:</p>
</div>  
            
        <?php
        //$query1 = "SELECT cartid FROM order WHERE customerid = '$customer_id' AND reviewStatus = 'uncomplete'"
        
        $query = "SELECT * FROM cartitem WHERE cartid = '$last_cart_id' ";
        ...
        <div class="container-cart">
            ...
            <div class="cart">
                <div class="product">
                    ...
                    <button type="submit" class="product-remove" name="leaveReview_btn" value="<?php echo $product_id; ?>">Leave Review</button>
                </form>
                    <?php else : ?>
